...
BEGIN
    ...
    SELECT ' || p_FieldList || ' FROM (
        ...
        FROM "tEvent" eh
        INNER JOIN "tEventOffer" eo ON eh."eventId" = eo."eventId"
...
ALTER FUNCTION public."spRetailPricingEPPOtIC"(p_eventid integer, p_page integer, p_pageposn integer, p_comoffertypeid character varying, p_comofferic character varying, p_criteria character varying, p_fieldlist character varying)
